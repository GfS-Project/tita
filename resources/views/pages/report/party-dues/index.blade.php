...
@section('title')
    {{ ucfirst(request('party_type')) }} Due List
@endsection
            ...
            <div class="tab-content order-summary-tab">
                <div class="tab-pane fade active show" id="payment-status" role="tabpanel">
                    <div class="table-header mt-3">
                        <h4>{{ ucfirst(request('party_type')) }} Due List</h4>
                    </div>
                    ...
                    <div class="table-top-form daily-transaction-between-wrapper">
                        <form action="{{ route('reports.party-dues.filter', ['party_type' => request('party_type')]) }}" method="post" class="filter-form due-list-filter" table="#dues-data">
                            <div class="grid-5">
                                @csrf
                        ...
                        <div class="table-top-btn-group">
                            <ul>
                                <li>
                                    <a href="{{ route('party-dues.pdf', ['type' => request('party_type')]) }}">
                                ...
                                <li>
                                    <a id="download-csv" data-filename="{{ ucfirst(request('party_type')) . '-Due-List' . formatted_date(now(), "d/m/Y H:i:s") }}" data-table-headings="SL., Party Name, Phone,	Address, Due Amount, Remarks">
                    ...
                    <div class="responsive-table">
                        <div class="table-header justify-content-center border-0 d-block text-center print-inner-page">
                            ...
                            <h4 class="mt-2">{{ ucfirst(request('party_type')) }} Due List</h4>
                        </div>
                        <div id="datatable_wrapper" class="dataTables_wrapper no-footer">
                            <table class="table no-footer" id="erp-table">
                                <thead>
                                    <tr>
                                        <th>SL.</th>
                                        <th>Party Name</th>
                                ...
                                <tbody id="dues-data">
                                    @include('pages.report.party-dues.datas')
                                </tbody>
                            </table>
                        </div>
                    </div>
