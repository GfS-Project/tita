        ...
        <div class="tab-content order-summary-tab">
            <div class="tab-pane fade active show" id="add-new-petty" role="tabpanel">
                <div class="table-header">
                    <h4>Note : <span class="custom-warning">Dont Use Any Kind Of Space In The Input Fields</span></h4>
                </div><br>
                            ...
                            <div class="row">
                                <div class="col-12 col-sm-12 col-md-4">
                                    <ul class="nav nav-pills flex-column shadow w-280 p-2">
                                        <li class="nav-item">
                                            <a href="#app" id="home-tab4" class="add-report-btn active nav-link" data-bs-toggle="tab">App</a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="#Drivers" class="add-report-btn nav-link" data-bs-toggle="tab">Drivers</a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="#storage" class="add-report-btn nav-link" data-bs-toggle="tab">Storage Settings</a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="#mail-configuration" class="add-report-btn nav-link" data-bs-toggle="tab">Mail Configuration</a>
                                        </li>
                                ...
                                <div class="col-12 col-sm-12 col-md-8">
                                    <div class="card border-0 shadow">
                                        <div class="card-body">
                                            <form action="{{ route('system-settings.store') }}" method="post" class="ajaxform">
                                                @csrf
                                                ...
                                                <div class="tab-content no-padding">
                                                    <div class="tab-pane fade show active" id="app">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" required name="APP_DEBUG">
                                                                <option value="true" {{ env('APP_DEBUG', 'false') === 'true' ? 'selected' : '' }}>true (Developers Only)</option>
                                                                <option value="false" {{ env('APP_DEBUG', 'false') === 'false' ? 'selected' : '' }}>false</option>
                                                            </select>
                                                        </div>
                                                        <div class="form-group">
                                                            <label>APP_URL</label>
                                                    ...
                                                    <div class="tab-pane fade" id="mail-configuration">
                                                        <div class="form-group">
                                                            <label for="QUEUE_MAIL" class="required">QUEUE_MAIL</label>
                                                            <select name="QUEUE_MAIL" id="QUEUE_MAIL" class="form-control">
                                                                <option value="true" {{ env('QUEUE_MAIL', 'false') === 'true' ? 'selected' : '' }}>true</option>
                                                                <option value="false" {{ env('QUEUE_MAIL', 'false') === 'false' ? 'selected' : '' }}>false</option>
                                                            </select>
                                                        </div>
                                                        <div class="form-group">
                                                            <label>MAIL_DRIVER_TYPE</label>
                                                            <select name="MAIL_DRIVER_TYPE" class="form-control" id="mail-driver-type-select">
                                                                <option value="MAIL_MAILER" @selected(env('MAIL_MAILER') ? 'selected' : '')>MAIL MAILER</option>
                                                                <option value="MAIL_DRIVER" @selected(env('MAIL_DRIVER') ? 'selected' : '')>MAIL DRIVER</option>
                                                            </select>
                                                        </div>
                                                        <div class="form-group">
                                                        ...
                                                        <span>QUEUE COMMAND Path : <span class="text-danger">/home/u186958312/domains/maanai.acnoo.com/public_html/maanai</span></span><br>
                                                    ...
                                                    <div class="tab-pane fade" id="Drivers">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" name="CACHE_DRIVER" required>
                                                                <option value="array" {{ old('CACHE_DRIVER', 'file') == 'array' ? 'selected' : '' }}>Array (Low Performance)</option>
                                                                <option value="file" {{ old('CACHE_DRIVER', 'file') == 'file' ? 'selected' : '' }}>File (Good Performance)</option>
                                                                <option value="memcached" {{ old('CACHE_DRIVER', 'file') == 'memcached' ? 'selected' : '' }}>Memcached (Don't Enable If You Don't Have Memcached Extension)</option>
                                                                <option value="redis" {{ old('CACHE_DRIVER', 'file') == 'redis' ? 'selected' : '' }}>Redis (Don't Enable If You Don't Have phpredis Extension)</option>
                                                            </select>
        
                                                            <small class="text-danger">Recommended <strong>Memcached or Redis</strong> Cache Driver For Height Performance Application And Optimize Call Database Query</small>
                                                        </div>
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" required="" name="SESSION_LIFETIME" class="form-control" value="{{ env('SESSION_LIFETIME') ?? '' }}">
                                                        </div>
                                                    ...
                                                    <div class="tab-pane fade" id="storage">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" name="FILESYSTEM_DISK">
                                                                ...
                                                                <option value="wasabi">Wasabi Storage Bucket</option>
                                                                <option value="public">public (uploads folder)</option>
                                                            </select>
                                                        </div>
            
                                                        <hr>
                                                        <p class="custom-warning">Fill up this credentials if you want to use AWS S3 Storage Bucket</p>
                                                        <div class="form-group">
                                                        ...
                                                        <hr>
                                                        <p class="custom-warning">Fill up this credentials if you want to use Wasabi Storage Bucket</p>
                                                        <div class="form-group">
