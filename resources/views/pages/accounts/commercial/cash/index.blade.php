...
@section('main_content')
                ...
                <div class="erp-state-overview-wrapper">
                    <div class="state-overview-box daily-transaction-between-wrapper">
                        ...
                        <div class="count-content-wrapper">
                            <h2>{{ currency_format($total_credit - $total_debit) }}</h2>
                    ...
                    <div class="state-overview-box daily-transaction-between-wrapper">
                        ...
                        <div class="count-content-wrapper">
                            <h2>{{ currency_format($total_credit) }}</h2>
                            <p>{{__('Total Credit')}}</p>
                        </div>
                    </div>
                    <div class="state-overview-box daily-transaction-between-wrapper">
                        ...
                        <div class="count-content-wrapper">
                            <h2>{{ currency_format($total_debit) }}</h2>
                            <p>{{__('Total Debit')}}</p>
                        </div>
                    </div>
                </div>
    ...
    <div class="erp-table-section">
        <div class="container-fluid">
            <div class="table-header">
                ...
                @can('cashes-create')
                <a href="#adjust-cash" class="add-order-btn rounded-2" data-bs-toggle="modal">{{__('Adjust Cash')}}</a>
                @endcan
            </div>
            <div class="table-top-form daily-transaction-between-wrapper">
                <form action="{{ route('cash.filter') }}" method="post" class="filter-form" table="#cash-data">
                    @csrf
                ...
                <div class="table-top-btn-group d-flex">
                    <ul>
                        ...
                        <li>
                            <a href="{{ route('exports.index', ['model' => 'Cash', 'extension' => 'csv']) }}">
                                <svg class="w-17 h-16" viewBox="0 0 17 16" fill="none"
                                     xmlns="http://www.w3.org/2000/svg">
                                    <path
                        ...
                        <li>
                            <a href="{{ route('exports.index', ['model' => 'Cash', 'extension' => 'xlsx']) }}">
            ...
            <div class="responsive-table">
                ...
                <table class="table" id="erp-table">
                    ...
                    <tbody id="cash-data">
                        @include('pages.accounts.commercial.cash.datas')
                    </tbody>
                </table>
                <nav>
                    <ul class="pagination">
                        <li class="page-item">{{ $cashes->links() }}</li>
                    </ul>
                </nav>
            </div>
        </div>
    ...
    @push('modal')
        @include('pages.accounts.commercial.cash.create')
        @include('pages.accounts.commercial.cash.view')
    @endpush
