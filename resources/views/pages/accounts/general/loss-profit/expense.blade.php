...
@section('main_content')
    <div class="erp-table-section">
        <div class="container-fluid">
            ...
            <div class="tab-content order-summary-tab">
                <div class="tab-pane fade {{ Request::RouteIs('loss-profit.expense') ? 'show active' : '' }}" id="payment-status">
                    ...
                    <div class="total-count-area">
                        <div class="count-item light-orange">
                            <h5>
                                <span class="counter">
                                    <span class="total-expense">{{ currency_format(collect($expense_data)->flatten(1)->sum('total_amount') + $others_expense->sum('total_amount')) }}</span>
                                </span>
                            </h5>
                    ...
                    <div class="table-top-form daily-transaction-between-wrapper loss-profit">
                        <div class="grid-5">
                            <div class="row">
                                <div class="col-sm-6 col-md-3">
                                    <select class="table-select form-control expense-year w-100">
                        ...
                        <div class="table-top-btn-group">
                            <ul>
                                <li>
                                    <a id="download-csv" data-filename="{{ 'Expense-List' . formatted_date(now(), "d/m/Y H:i:s") }}" data-table-headings="Category,	January,	February,	March,	April,	May,	June,	July,	August,	September,	October,	November,	December,	Total">
                                ...
                                <li>
                                    <a id="download-xlsx" data-filename="{{ 'Expense-List' . formatted_date(now(), "d/m/Y H:i:s") }}" data-table-headings="Category,	January,	February,	March,	April,	May,	June,	July,	August,	September,	October,	November,	December,	Total">
                    ...
                    <div class="responsive-table">
                        <table class="table table-bordered" id="erp-table">
                            ...
                            <tbody class="report-expense-data">
                                @include('pages.accounts.general.loss-profit.expense-datas')
                            </tbody>
                        </table>
                    </div>
                </div>
    ...
    <input type="hidden" id="url" value="{{ route('loss-profit.expense.filter') }}">
@endsection
