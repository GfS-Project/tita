        ...
        <div class="container-fluid">
            ...
            <div class="table-header justify-content-end border-0 p-0">
                <div class="button-group nav">
                    @can('samples-read')
                    <a href="#Sample-list" class="add-report-btn active" data-bs-toggle="tab">{{__('Sample List')}}</a>
                    @endcan
                    @can('samples-create')
                    <a href="#add-new-sample" class="add-report-btn" data-bs-toggle="tab">{{__('Add New Sample')}}</a>
                    @endcan
                </div>
            </div>
            <div class="tab-content order-summary-tab">
                @can('samples-read')
                <div class="tab-pane fade show active" id="Sample-list">
                    <div class="table-header">
                        <h4>{{__('Sample List')}}</h4>
                    </div>
                    <div class="table-top-form daily-transaction-between-wrapper">
                        <form action="{{ route('sample.filter') }}" method="post" class="filter-form" table="#sample_data">
                            @csrf
                            <div class="grid-5">
                        ...
                        <div class="table-top-btn-group">
                            <ul>
                                ...
                                <li>
                                    <a href="{{ route('exports.index', ['model' => 'Sample', 'extension' => 'csv']) }}">
                                        <svg class="w-17 h-16" viewBox="0 0 17 16" fill="none"
                                             xmlns="http://www.w3.org/2000/svg">
                                            <path
                                ...
                                <li>
                                    <a href="{{ route('exports.index', ['model' => 'Sample', 'extension' => 'xlsx']) }}">
                    ...
                    <div class="responsive-table">
                        <div class="table-header justify-content-center border-0 d-block text-center print-inner-page">
                            ...
                            <h4 class="mt-2">{{ __('Sample List') }}</h4>
                        </div>
                ...
                @endcan
                @can('samples-create')
                <div class="tab-pane fade" id="add-new-sample">
                    @include('pages.sample.create')
                 </div>
                @endcan
            </div>
