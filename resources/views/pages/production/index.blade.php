            ...
            <div class="erp-table-section">
                    ...
                    <div class="table-header justify-content-end border-0 p-0">
                        <div class="button-group nav">
                            ...
                            <a href="#order-summary" class="add-report-btn active" data-bs-toggle="tab">{{ __('Production List') }}</a>
                            @endcan
                            @can('productions-create')
                            <a href="#add-daily-report" class="add-report-btn" data-bs-toggle="tab">{{ __('Add Daily Production') }}</a>
                            @endcan
                        </div>
                    </div>
                    <div class="tab-content order-summary-tab">
                        ...
                        <div class="tab-pane fade show active" id="order-summary">
                            ...
                            <div class="table-top-form daily-transaction-between-wrapper flex-wrap-xl-xxl">
                                <form action="{{ route('productions.filter') }}" method="POST" class="filter-form" table="#production-data">
                                    @csrf
                                    <div class="grid-5">
                                ...
                                <div class="table-top-btn-group">
                                    <ul>
                                        ...
                                        <li>
                                            <a href="{{ route('exports.index', ['model' => 'Production', 'extension' => 'csv']) }}">
                                                <svg class="w-17 h-16" viewBox="0 0 17 16" fill="none"
                                                     xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                        ...
                                        <li>
                                            <a href="{{ route('exports.index', ['model' => 'Production', 'extension' => 'xlsx']) }}">
                            ...
                            <h4 class="table-title  justify-content-center daily-transaction-between-wrapper">{{__('Daily Production List')}}</h4>
                            <div class="responsive-table mt-0">
                                <div class="table-header justify-content-center border-0 d-block text-center print-inner-page">
                                    ...
                                    <h4 class="mt-2">{{__('Daily Production List')}}</h4>
                                </div>
                                <table class="table table-two" id="erp-table">
                                    <thead>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{__('Remarks')}}</td>
                                        <td class="print-d-none">{{__('Action')}}</td>
                                    </tr>
                                    </thead>
                                    <tbody id="production-data">
                                        @include('pages.production.datas')
                                    </tbody>
                                </table>
                            </div>
                            <div>
                        ...
                        @endcan
                        @can('productions-create')
                        <div class="tab-pane fade" id="add-daily-report">
                            <div class="table-header">
                                <h4>{{__('Add Daily report')}}</h4>
                            </div>
                            @include('pages.production.create')
                        </div>
                        @endcan
                    </div>
