        ...
        <div class="container-fluid">
            ...
            <div class="table-header justify-content-end border-0 p-0">
                <div class="button-group nav">
                    @can('orders-read')
                        <a href="#order-summary" class="add-report-btn active" data-bs-toggle="tab">{{__('Order Summary')}}</a>
                    @endcan
                    @can('orders-create')
                        <a href="#add-new-order" class="add-order-btn" data-bs-toggle="tab">{{__('Add New Order')}}</a>
                    @endcan
                </div>
            </div>
            <div class="tab-content order-summary-tab">
                <div class="tab-pane fade show active" id="order-summary">
                    ...
                    <div class="table-top-form daily-transaction-between-wrapper flex-wrap-xl-xxl">
                        <form action="{{ route('order.filter') }}" method="post" class="filter-form" table="#order-data">
                            @csrf
                            <div class="grid-5">
                        ...
                        <div class="table-top-btn-group">
                            <ul>
                                ...
                                <li>
                                    <a href="{{ route('exports.index', ['model' => 'Order', 'extension' => 'csv']) }}">
                                        <svg class="w-17 h-16" viewBox="0 0 17 16" fill="none"
                                             xmlns="http://www.w3.org/2000/svg">
                                            <path
                                ...
                                <li>
                                    <a href="{{ route('exports.index', ['model' => 'Order', 'extension' => 'xlsx']) }}">
                    ...
                    <div class="responsive-table">
                        <div class="table-header justify-content-center border-0 d-block text-center print-inner-page">
                            ...
                            <h4 class="mt-2">{{__('Order Transaction')}}</h4>
                        </div>
                        <table class="table" id="erp-table">
                            ...
                            <tbody id="order-data">
                            @include('pages.order.summery.datas')
                            </tbody>
                        </table>
                    </div>
                    <nav>
                ...
                <div class="tab-pane fade" id="add-new-order">
                    @include('pages.order.summery.create')
                </div>
            </div>
