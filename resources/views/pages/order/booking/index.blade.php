        ...
        <div class="container-fluid">
            ...
            <div class="table-header justify-content-end border-0 p-0">
                <div class="button-group nav">
                    @can('bookings-read')
                        <a href="#booking-list" class="add-report-btn active" data-bs-toggle="tab">{{__('Booking List')}}</a>
                    @endcan
                    @can('bookings-create')
                        <a href="#add-booking" class="add-report-btn" data-bs-toggle="tab">{{__('Add New Booking')}}</a>
                    @endcan
                </div>
            </div>
            <div class="tab-content order-summary-tab">
                @can('bookings-read')
                    <div class="tab-pane fade show active" id="booking-list">
                        ...
                        <div class="table-top-form daily-transaction-between-wrapper flex-wrap-xl-xxl">
                            <form action="{{ route('booking.filter') }}" method="post" class="filter-form" table="#booking-data">
                                @csrf
                                <div class="grid-5">
                                    ...
                                    <div class="input-wrapper w-150-xl-xxl">
                                    ...
                                    <div class="input-wrapper align-items-center">
                                        ...
                                        <input type="date" name="form_date" class="form-control datepicker">
                                    </div>
                                    <div class="input-wrapper align-items-center">
                            ...
                            <div class="table-top-btn-group">
                                <ul>
                                    ...
                                    <li>
                                        <a href="{{ route('exports.index', ['model' => 'Booking', 'extension' => 'csv']) }}">
                                            <svg class="w-17 h-16" viewBox="0 0 17 16" fill="none"
                                                 xmlns="http://www.w3.org/2000/svg">
                                                <path
                                    ...
                                    <li>
                                        <a href="{{ route('exports.index', ['model' => 'Booking', 'extension' => 'xlsx']) }}">
                        ...
                        <div class="responsive-table">
                            <div class="table-header justify-content-center border-0 d-block text-center print-inner-page">
                                ...
                                <h4 class="mt-2">{{__('Booking List')}}</h4>
                            </div>
                            <table class="table" id="erp-table">
                                ...
                                @include('pages.order.booking.datas')
                                </tbody>
                            </table>
                        </div>
                        <nav>
                            <ul class="pagination">
                                <li class="page-item">{{ $bookings->links() }}</li>
                            </ul>
                        </nav>
                    </div>
                @endcan
                @can('bookings-create')
                    <div class="tab-pane fade" id="add-booking">
                        @include('pages.order.booking.create')
                    </div>
                @endcan
            </div>
        </div>
            ...
            <div class="modal-content">
                ...
                <form action="" method="post" class="ajaxform_instant_reload reject-form">
                    ...
                    <div class="modal-body">
                        <input type="hidden" class="booking-status" name="status">
