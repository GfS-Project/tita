        ...
        <div class="container-fluid">
            ...
            <div class="table-header justify-content-end border-0 p-0">
                <div class="button-group nav">
                    @can('shipments-read')
                    <a href="#order-summary" class="add-report-btn active" data-bs-toggle="tab">{{__('Shipment List')}}</a>
                    @endcan
                    @can('shipments-create')
                    <a href="#add-new-order" class="add-order-btn" data-bs-toggle="tab">{{__('Add New Shipment')}}</a>
                    @endcan
                </div>
            </div>
            <div class="tab-content order-summary-tab">
                ...
                <div class="tab-pane fade show active" id="order-summary">
                    <div class="table-header">
                        <h4>{{__('Shipment List')}}</h4>
                    </div>
                    <div class="table-top-form daily-transaction-between-wrapper">
                        <form action="{{ route('shipment.filter') }}" method="post" class="filter-form" table="#shipment-data">
                            @csrf
                            <div class="grid-5">
                        ...
                        <div class="table-top-btn-group">
                            <ul>
                                ...
                                <li>
                                    <a href="{{ route('exports.index', ['model' => 'Shipment', 'extension' => 'csv']) }}">
                                        <svg class="w-17 h-16" viewBox="0 0 17 16" fill="none"
                                             xmlns="http://www.w3.org/2000/svg">
                                            <path
                                ...
                                <li>
                                    <a href="{{ route('exports.index', ['model' => 'Shipment', 'extension' => 'xlsx']) }}">
                    ...
                    <div class="responsive-table">
                        <div class="table-header justify-content-center border-0 d-block text-center print-inner-page">
                            ...
                            <h4 class="mt-2">{{__('Shipment List')}}</h4>
                        </div>
                        <table class="table" id="erp-table">
                            ...
                            <tbody id="shipment-data">
                                @include('pages.order.shipment.datas')
                            </tbody>
                        </table>
                    </div>
                    <div>
                ...
                <div class="tab-pane fade" id="add-new-order">
                    @include('pages.order.shipment.create')
                </div>
                @endcan
            </div>
        </div>
