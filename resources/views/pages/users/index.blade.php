                    ...
                    <div class="tab-content order-summary-tab">
                        <div class="tab-pane fade show active" id="user-list">
                            <div class="table-header">
                                <h4>{{ ucfirst(request('users') ?? request('users')) }} {{__('List')}}</h4>
                            </div>
                            <div class="table-top-form daily-transaction-between-wrapper">
                                <form action="{{ route('user.filter', ['role' => request('users')]) }} " method="post" class="filter-form" table="#user-data">
                                    @csrf
                                    <div class="grid-5">
                                ...
                                <div class="table-top-btn-group">
                                    <ul>
                                        <li>
                                            <a href="{{ route('users.pdf', ['role' => request('users')]) }}">
                                        ...
                                        <li>
                                            <a href="{{ route('exports.index', ['model' => 'User', 'extension' => 'csv', 'role' => request('users') ]) }}">
                                                <svg class="w-17 h-16" viewBox="0 0 17 16" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                        ...
                                        <li>
                                            <a href="{{ route('exports.index', ['model' => 'User', 'extension' => 'xlsx', 'role' => request('users')]) }}">
                            ...
                            <div class="responsive-table">
                                <div class="table-header justify-content-center border-0 d-block text-center print-inner-page">
                                    ...
                                    <h4 class="mt-2">{{ ucfirst(request('users') ?? request('users')) }} {{__('List')}}</h4>
                                </div>
